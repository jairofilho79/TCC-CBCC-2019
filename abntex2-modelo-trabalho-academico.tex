...
\begin{resumo}
	...
	Neste trabalho é apresentado e analisado o protótipo de geração e visualização de dados sintéticos chamado de Blocks Data Generator.
	O objetivo foi modelar, visualizar e avaliar a geração de dados sintéticos faltantes e discrepantes.
...
\begin{resumo}[Abstract]
 \begin{otherlanguage*}{english}
   In this paper it's presented and analyzed the prototype of synthetic data generation and synthetic data visualization called Blocks Data Generator.
   The goals was modelling, visualizing and evaluate the generation of missing synthetic data and synthetic outliers.
