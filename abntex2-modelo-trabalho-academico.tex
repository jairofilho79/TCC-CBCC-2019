...
\chapter{Resultados}
	...
	\section{Modelagem dos Dados}
		...
		Foram criadas 3 bases de dados de contextos genéricos, simulando abstratamente contextos reais.
		...
		Também foram utilizados outros geradores para auxiliar no comportamento das dimensões como os
		 \emph{Linear Funcion}, \emph{Linear Scale}, \emph{MinMax}, \emph{Uniform Generator}, \emph{Gaussian Generator}, \emph{Piecewise Function} e \emph{Categorical} para geração de nomes.
		\par
	...
	\section{Validação da Modelagem}
		Para validar os dados, foram utilizadas 3 visualizações encontradas no Blocks Data Generator.
		As visualizações são Coordenadas Pararelas, Matriz \emph{Scatter Plot} e Histograma.
		O objetivo é encontrar as características listadas na tabela \ref{table:resumo caracteristica dimensao bases de validacao}.
		Com isso, verificar a qualidade do Blocks Data Generator de gerar dados faltantes e discrepantes.
		%Com fé no pai, vou encontrar!
