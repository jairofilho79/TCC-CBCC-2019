...
% ---
\section{Funções de Geração de Dados}
% ---

\subsection{Sequencial}
\subsubsection{Gerador 1}
\subsubsection{Gerador 1}
\subsubsection{Gerador 1}
\subsubsection{Gerador 1}
\subsubsection{Gerador 1}
...
\chapter{Materiais e Metodologias}\label{cap_trabalho_academico}
\section{Para o planejamento do projeto}
\section{Para o monitoramento do projeto}
\section{Para o desenvolvimento do projeto}
\section{Para a manutenção do protótipo}
