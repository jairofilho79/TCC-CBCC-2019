...
\chapter{Trabalhos Relacionados}
	...
	\section{Trabalhos acadêmicos relacionados}
		...
		No trabalho feito por Sakshaug and Raghunathan foi aplicado um procedimento de simulação não paramétrica para geração de dados sintéticos de variáveis contínuas com o foco em pequenas áreas geográfica. 
		...
		Com o foco em CARS (Context-Aware Recommender Systems - Sistemas de Recomendação sensíveis ao contexto), o DataGenCARS é uam ferramenta para gerar dados sintéticos de forma flexível e prática.
		...
		Pensando em oferecer confidencialidade dos dados governamentais, Larsen and Huckett desenvolveram um gerador de dados sintéticos que alia regressão de quartis com imputação \emph{hot deck} e troca de classificação.
