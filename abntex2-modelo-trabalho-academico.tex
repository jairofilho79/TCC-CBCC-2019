...
% ---
	...
	\section{Modos para Visualização de Dados}
		...
		Dentre as visualizações disponíveis pode-se citar as Coordenadas Paralelas, \emph{Scatterplot} % Ver outras visualizações em casa.
	...
	\section{Estrutura de Interação Humano Computador}
		% Explicar como utilizar os elementos da interface. 
