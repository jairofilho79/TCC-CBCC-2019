...
% ---
	...
	\section{Tipos de Geradores de Dados}
		...
		A categoria funcional \emph{Function} serve para gerar dados de acordo com outra dimensão, isto é, facilita a correlação entre dimensões.
		...
		a \emph{TimeLaps Function} a qual funciona de forma semelhante a \emph{Piecewise Function}, só que utiliza uma quantidade de tempo como limiar, chamado de \emph{Laps} e também geradores de tempo.
