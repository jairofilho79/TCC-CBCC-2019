...
% ---
	...
	\section{Tipos de Geradores de Dados}
		...
		\begin{table}[h]
			\centering
			\caption{Geradores do Blocks Data Generator}
			\vspace{0.5cm}
			\label{table: geradores blocks}
			\begin{tabular}{l|l|l|l|l|l|l}
			
				Nome                 & Categoria  & Tipo dos valores                 & Tipo dos parâmetros                                                                    & Correlação & Independente & Resumo \\ % Note a separação de col. e a quebra de linhas
				\hline % para uma linha horizontal
				Constant             & Sequencial & Numérico                         & Selecionável, Número, Número, Número                                                   & Não        & Sim          & Gera uma sequência de \textbf{números} com sempre o mesmo número.\\
				Counter              & Sequencial & Numérico                         & Selecionável, Número, Número                                                           & Não        & Sim          & Gera uma sequência de \textbf{números} que é incrementada ou decrementada.\\
				Fixed Time           & Sequencial & Temporal                         & Selecionável, Número, Número, Tempo, Tempo, Caracteres                                 & Não        & Sim          & Gera uma sequência de \textbf{tempo} que é incrementada ou decrementada.\\
				Sinusoidal Sequence  & Sequencial & Numérico                         & Selecionável, Número, Número, Número, Número, Número                                   & Não        & Sim          & Gera uma sequência de \textbf{números} de acordo com uma função senoidal.\\
				Custom Sequence      & Sequencial & Numérico                         & Selecionável, Número, Número, Caracteres                                               & Não        & Sim          & Gera uma sequência de \textbf{números} cujo comportamento é dado pelo usuário.\\
				%--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
				Poisson Time         & Aleatório  & Temporal                         & Selecionável, Tempo, Número, Selecionável, Caracteres, Número                          & Não        & Sim          & Gera valores aleatórios \textbf{temporais} em uma distribuição de acordo com a função de Poisson.\\
				Uniform              & Aleatório  & Numérico                         & Selecionável, Número, Número, Checável                                                 & Não        & Sim          & Gera valores aleatórios \textbf{númericos} em uma distribuição uniforme.\\
				Gaussian             & Aleatório  & Numérico                         & Selecionável, Número, Número                                                           & Não        & Sim          & Gera valores aleatórios \textbf{númericos} em uma distribuição de acordo com a função Gaussiana.\\
				Poisson              & Aleatório  & Numérico                         & Selecionável, Número                                                                   & Não        & Sim          & Gera valores aleatórios \textbf{númericos} em uma distribuição de acordo com a função de Poisson.\\
				Bernoulli            & Aleatório  & Numérico                         & Selecionável, Número                                                                   & Não        & Sim          & Gera valores aleatórios \textbf{númericos} em uma distribuição de acordo com a função de Bernoulli.\\
				Cauchy               & Aleatório  & Numérico                         & Selecionável, Número, Número                                                           & Não        & Sim          & Gera valores aleatórios \textbf{númericos} em uma distribuição de acordo com a função de Cauchy.\\
				Weighted Categorical & Aleatório  & Categórico                       & Selecionável, Lista de Caracteres, Lista de Números                                    & Não        & Sim          & Gera valores aleatórios \textbf{categóricos} dada uma lista de categorias com probabilidade ponderada.\\
				Categorical          & Aleatório  & Categórico                       & Selecionável, Lista de Caracteres                                                      & Não        & Sim          & Gera valores aleatórios \textbf{categóricos} dada uma lista de categorias.\\
				Categorical Quantity & Aleatório  & Categórico                       & Selecionável, Lista de Caracteres, Lista de Números                                    & Não        & Sim          & Gera valores aleatórios \textbf{categóricos} dada uma lista de categorias definindo a quantidade de aparição de categorias. \\
				%--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
				Linear               & Função     & Numérico                         & Selecionável, Dimensão, Número, Número                                                 & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{númerica} em uma função linear.\\
				Quadratic            & Função     & Numérico                         & Selecionável, Dimensão, Número, Número, Número                                         & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{númerica} em uma função quadrática.\\
				Polynomial           & Função     & Numérico                         & Selecionável, Dimensão, Lista de Números                                               & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{númerica} em uma função polinomial.\\
				Exponential          & Função     & Numérico                         & Selecionável, Dimensão, Número, Número                                                 & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{númerica} em uma função exponencial.\\
				Logarithm            & Função     & Numérico                         & Selecionável, Dimensão, Número                                                         & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{númerica} em uma função logarítmica.\\
				Sinusoidal           & Função     & Numérico                         & Selecionável, Dimensão, Número, Número, Número                                         & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{númerica} em uma função senoidal.\\
				Categorical          & Função     & Categórico                       & Selecionável, Dimensão                                                                 & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{categórica}.\\
				Piecewise            & Função     & Numérico                         & Selecionável, Dimensão, Número                                                         & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{númerica} com limiar recebe dados de 2 outros geradores. \\
				TimeLaps             & Função     & Temporal                         & Selecionável, Dimensão, Tempo                                                          & Sim        & Sim          & Gera valores a partir de uma dimensão \textbf{temporal} que ao atingir o tempo definido ele dados de um novo gerador.  \\
				%--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
				MCAR                 & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Caracteres, Número                                                       & Não        & Não          & Gera valores faltantes aleatoriamente com auxílio de um ou mais geradores dada uma probabilidade. \\
				MAR                  & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Caracteres, Selecionável, Caracteres, Caracteres, Dimensão               & Sim        & Sim          & Gera valores faltantes com auxílio a partir de uma dimensão e com parâmetros definidos pelo usuário faltantes. \\
				MNAR                 & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Caracteres, Selecionável, Caracteres, Caracteres                         & Não        & Não          & Gera valores faltantes com auxílio de um ou mais geradores com parâmetros definidos pelo usuário para ter dados faltantes. \\
				Noise                & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Selecionável, Número, Número                                             & Não        & Não          & Gera valores ruidosos com auxílio de um mais geradores dada uma probabilidade e intensidade. \\
				Constant Noise       & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Número, Número                                                           & Não        & Não          & Gera dados ruidosos com valor específico constante com auxílio de um mais geradores dada uma probabilidade. \\
				Range Filter         & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Número, Número                                                           & Não        & Não          & Dado um ou mais geradores, os dados que estão no intervalo não são gerados.\\
				Linear Scale         & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Número, Número, Número, Número                                           & Não        & Não          & Dado um ou mais geradores, os dados são escalados de acordo com os parâmetros definidos. \\
				No Repeat            & Acessório  & Numérico, Temporal ou Categórico & Selecionável                                                                           & Não        & Não          & Dado um ou mais geradores, são retirados os dados repetidos. \\
				MinMax               & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Número, Número                                                           & Não        & Não          & Permite escolher qual será o valor máximo e o mínimo gerados. \\
				Low-Pass Filter      & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Número                                                                   & Não        & Não          & Dado um ou mais geradores, este simula o resultado de um filtro passa-baixa.\\
				Get Extra Value      & Acessório  & Numérico, Temporal ou Categórico & Selecionável, Caracteres, Número                                                       & Não        & Não          & Recebe o valor de dados multidimensionais. \\
				%--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
				CubicBezier          & Geométrico & Numérico                         & Selecionável, Número, Número, Número, Número, Número, Número, Número, Número, Checável & Não        & Sim          & Gera dados para desenhar uma curva Bezier cúbica. \\
				Path2D Stroke        & Geométrico & Numérico                         & Selecionável, Caracteres                                                               & Não        & Sim          & Gera dados para desenhar a borda de um polígono. \\
				Path2D Fill          & Geométrico & Numérico                         & Selecionável, Caracteres                                                               & Não        & Sim          & Gera dados para preencher um polígono. \\
			\end{tabular}
		\end{table}
		Na tabela \ref{table: geradores blocks} são apresentados, de forma geral, todos os geradores do Blocks Data Generator. São apresentados seus nomes, suas categorias, o tipo de valores retornados, os tipos de parâmetros, se possui correlação - o que na prática é se um dos parâmetros é uma outra dimensão - , se são independentes - ou seja, se precisa encadear geradores para funcionar corretamente - e um breve resumo.
		...
		\subsection{Geométrico}
			...
			O primeiro deles (\emph{Path2D Stroke}) gera dados bidimensionais a partir da linha inserida pelo usuário.
			O segundo, este gerado os dados a partir do preenchimento da linha desenhada (ver algoritmo \emph{Floodfill}) pelo usuário (\emph{Path2D Fill}).
			Quanto ao terceiro, este gera dados para desenho de uma curva bezier cúbica (\emph{CubicBezier}) a partir de seus pontos.
