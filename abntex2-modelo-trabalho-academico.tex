...
%-- TODO: 
	...
	\section{Técnicas e ferramentas utilizadas}
	A equipe do Blocks Data Generator é composta por 3 pessoas, o administrador Prof. Dr. Gustavo Resque da UFPa, o aluno de mestrado Yvan Brito e o aluno da graduação Jairo Filho - ambos da UFPa - com colaborações avulsas de membros do Laboratório de Visualização e Sistemas Inteligentes da UFPa.
	O software é \emph{Open Source} e está hospedado no GitHub em \url{http://github.com/gustavoresque/DataGenerator}.
...
\chapter{Teste}
% ---
	% Teste de exaustão na geração de dados
