	...
	\section{Aplicações Relacionadas}
		...
		\begin{table}[h]
			...
			\begin{tabular}{r|lll}
				...
				Nome                 & Interface Gráfica & Dados Faltantes & Dados Discrepantes & Orientado a & Preço    \\ % Note a separação de col. e a quebra de linhas
				\hline                                  % para uma linha horizontal
...
% ---
	...
	\begin{figure}[h]
		...
		\footnotesize Fonte: adaptado de %TODO: Pegar dissertação do YVAN.
	\end{figure}
	\par
	...
	\section{Estrutura da Interface Gráfica do Blocks}
		...
		%TODO: Subdividir imagem.
		%TODO: Descrever as marcações em formato de lista.
		\begin{figure}[h]
			\centering
