...
% ---
	...
	\begin{figure}[h!]
		...
		\caption{Diagrama de Classes dos geradores do Blocks Data Generator. Fonte: o autor.}
	...
	\begin{figure}[h!]
		...
		\caption{Diagrama de Classes (2ª Geração) dos geradores do Blocks Data Generator. Fonte: o autor.}
	...
	\begin{figure}[h!]
		...
		\caption{Diagrama de Classes (3ª Geração) dos geradores do Blocks Data Generator. Fonte: o autor.}
		\label{fig:diagramaCDBaixo}
	\end{figure}

	\section{Sequência de atividades no Blocks}
	Para gerar os diagramas de sequência do Blocks Data Generator, foram utilizados os casos de uso UC06 e UC09, vistos na figura \ref{fig:diagramaUC}.
	...
	\begin{figure}[h!]
		...
		\caption{Diagrama de Sequência para geração de dados em arquivos no Blocks Data Generator. Fonte: O autor.}
		\label{fig:DiagramadeSequenciaArquivo}
	\end{figure}
	\par
	No diagrama de sequência visto na figura \ref{fig:DiagramadeSequenciaVisTechLib} é em relação ao UC06.
	...
	A partir dos dados, há uma comunicação via \emph{WebSocket} com o VisTechLib enviando os dados.
	O VisTechLib retorna as opções de visualização, o usuário escolhe uma e então é retornado a visualização para que esta seja renderizada.

	\begin{figure}[h!]
		\centering
		\includegraphics[width=\linewidth]{./figures/prototipo/DiagramadeSequenciaVisTechLib.png}
		\caption{Diagrama de Sequência para visualização dos dados no Blocks Data Generator. Fonte: o autor.}
		\label{fig:DiagramadeSequenciaVisTechLib}
	\end{figure}
% ---
	...
	\section{Tipos de Geradores de Dados}
		...
		\begin{table}[h]
			...
			\begin{tabular}{c|c|c|c|c}
				...
				Nome                 & Categoria  & T. dos valores                                            & Correlação & Independente \\ % Note a separação de col. e a quebra de linhas
				\hline % para uma linha horizontal
...
\chapter{Resultados}
	...
	E para melhorar a visualização dos faltantes foi utilizado o Matrix Plot (ver figura \ref{fig:Atletismo-Matrix-Plot}), contudo, foi diminuida a quantidade de dados, para não haver sobreposição dos dados.
...
O MCAR deve possuir o mesmo tipo de dado que está auxiliando, MAR e MNAR devem ter porcentagem de falta para que se torne mais suave a falta dos dados, e o MAR deve receber ou não os dados de outra coluna.
\par
